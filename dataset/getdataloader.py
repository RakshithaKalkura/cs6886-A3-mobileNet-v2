...
def GetCifar10(cfg):
    ...
    train_data = datasets.CIFAR10(root=cfg.data_dir, train=True, transform=trans_t, download=True)
    test_data = datasets.CIFAR10(root=cfg.data_dir, train=False, transform=trans, download=True)
